...
const HeroSlider = ({ children }) => {
  ...
  return (
    <div className="relative w-full min-h-[60vh] overflow-hidden rounded-3xl border border-border/60 shadow-xl">
      ...
      <div className="relative z-10 flex h-full items-end justify-center px-6 pb-16 pt-12">
